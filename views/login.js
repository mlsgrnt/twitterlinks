  ...
  return html`
    <body class="bg-blue white vh-100 dt w-100" >
            ...
            <div class="fr mh3 ma1 f1-ns f3">
              <a onclick=${handleClick} class=" link b blue bg-white hover-bg-washed-blue bg-animate pa3 br3 ${state.loginLoading ? 'loading' : ''}" href="">${state.loginLoading ? 'Loading...' : 'Log in with Twitter'}</a>
            </div>
